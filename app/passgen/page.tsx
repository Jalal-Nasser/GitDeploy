        ...
        <section className="relative pt-20 pb-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    <MsStoreBadge />
                    <a
                        href="https://apps.apple.com/sa/app/passgen-secret-vault/id6759681459"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="ml-4 inline-block transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95"
                        aria-label="Download PassGen Secret Vault on the App Store"
                    >
                        <img
