    ...
    return (
        <section className="relative pt-20 pb-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <a 
                    href="https://testflight.apple.com/join/Nt1cG1SZ" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="inline-flex items-center bg-black hover:bg-slate-900 border border-slate-700 text-white rounded-lg px-5 py-2 ml-4 transition-transform duration-200 hover:scale-105 active:scale-95 ease-in-out shadow-lg"
                    style={{ height: "60px" }}
                >
                    ...
                    <div className="flex flex-col items-start text-left">
                        <span className="text-[10px] font-medium leading-none mb-1 opacity-80 uppercase tracking-wider">Join on</span>
                        <span className="text-[19px] font-semibold leading-none">TestFlight</span>
                    </div>
                </a>
