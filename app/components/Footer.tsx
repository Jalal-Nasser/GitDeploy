                    ...
                    <div>
                        ...
                        <div className="mt-5">
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                                ...
                                <a href="https://www.linkedin.com/company/mdeploy/" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-2 rounded-full border border-border bg-background/60 px-3 py-2 text-sm text-muted-foreground transition hover:border-primary/60 hover:text-primary hover:bg-primary/5">
